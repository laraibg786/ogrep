...
// xmldoc, yamldoc, jsoncdoc, jsonldoc (structured data formats), and
// text (the plain-text, catch-all fallback). Add a new format's blank
// import here when its plugin package is ready.
package all
